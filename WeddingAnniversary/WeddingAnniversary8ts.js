function changeColor() {
    var randNumDec = []; // for containing random numbers decimally
    var randNumHex = []; // for containing converted numbers hexdecimally
    var cssIdList = ["row1_1", "row1_2", "row2", "row3"]; // css id list to change colors
    for (var i = 0; i < 4; i++) {
